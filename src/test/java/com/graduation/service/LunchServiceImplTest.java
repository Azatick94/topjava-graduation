...
class LunchServiceImplTest extends AbstractServiceTest {
    ...
    void saveNewLunchTest() {
        ...
        Lunch savedLunch = lunchService.save(newLunch);
    ...
    void updateLunchTest() {
        Lunch newLunch = lunchService.getByLunchId(100012);
        ...
        Lunch updatedLunch = lunchService.save(newLunch);
    ...
    void deleteTest() {
        ...
        assertNull(lunchService.getByLunchId(100030));
    }
